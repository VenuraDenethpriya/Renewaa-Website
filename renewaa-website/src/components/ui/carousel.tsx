...
const Slide = ({ slide, index, current, handleSlideClick }: SlideProps) => {
  ...
  const { src, button, title, product } = slide;
  const isUnderLeftContent = index < current;
      ...
      <div className="[perspective:1200px] [transform-style:preserve-3d]">
        ...
        >
          ...
          <Image
              ...
              style={{
                opacity: current === index ? 1 : isUnderLeftContent ? 0.3 : 0.6,
              }}
              alt={title}
              src={src}
              onLoad={imageLoaded}
          ...
          >
            ...
            {/* <div key={index} className="flex justify-center" onClick={() => setSelectedProduct(slide.product)}> */}
